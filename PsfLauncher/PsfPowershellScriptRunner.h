   ...
   struct MyProcThreadAttributeList
	...
	void RunScript(ScriptInformation& script, bool inside)
	{
		...
		{  
			...
			if (inside)
			{
				LogString(LogLevel_DebugBasic, L"DEBUG: Starting the script (inside) and waiting to finish", script.commandString.data());
			...
			{
				LogString(LogLevel_DebugBasic, L"DEBUG: Starting the script (outside) and waiting to finish", script.commandString.data());
		...
		else
		{
			...
			if (inside)
			{
				LogString(LogLevel_DebugBasic, L"Starting the script (inside) without waiting to finish", script.commandString.data());
			...
			{
				LogString(LogLevel_DebugBasic, L"Starting the script (outside) without waiting to finish", script.commandString.data());
