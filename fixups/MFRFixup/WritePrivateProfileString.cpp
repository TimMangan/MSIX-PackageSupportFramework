                ...
                case mfr::mfr_path_types::in_native_area:
                    ...
                    if (map.Valid_mapping)
                    {
                        ...
                        if (PathExists(testWsRedirected.c_str()))
                        {
                            ...
                            WRAPPER_WRITEPRIVATEPROFILESTRING(testWsRedirected, debug);
                        }
                        else if (PathExists(testWsPackage.c_str()))
                        {
                            if (Cow(testWsPackage, testWsRedirected, DllInstance, L"WritePrivateProfileStringFixup"))
                            {
                                WRAPPER_WRITEPRIVATEPROFILESTRING(testWsRedirected, debug);
                            }
                            else
                            {
                                WRAPPER_WRITEPRIVATEPROFILESTRING(testWsPackage, debug);
                            }
                        }
                        else
                        {
                            ...
                            PreCreateFolders(testWsRedirected.c_str(), DllInstance, L"WritePrivateProfileStringFixup");
                            WRAPPER_WRITEPRIVATEPROFILESTRING(testWsRedirected, debug);
                        }
                    }
                    ...
                    if (map.Valid_mapping)
                    {
                        ...
                        else if (PathExists(testWsNative.c_str()))
                        {
                            ...
                            {
                                if (Cow(testWsNative, testWsRedirected, DllInstance, L"WritePrivateProfileStringFixup"))
                                {
                                    WRAPPER_WRITEPRIVATEPROFILESTRING(testWsRedirected, debug);
                                }
                                else
                                {
                                    WRAPPER_WRITEPRIVATEPROFILESTRING(testWsNative, debug);
                                }
                            }
                            else
                            {
