...
namespace mfr
{
    ...
    void Initialize_MFR_Mappings()
    {
        ...
        g_MfrFolderMappings.push_back(mfr::mfr_folder_mapping{ true, FID_Desktop,                          L"ThisPCDesktopFolder",             L"ThisPCDesktopFolder",     g_packageVfsRootPath / L"ThisPCDesktopFolder"sv,    false, FID_Desktop,                                                    mfr::mfr_redirect_flags::prefer_redirection_local });
        g_MfrFolderMappings.push_back(mfr::mfr_folder_mapping{ true, FID_Documents,                        L"Personal",                        L"Personal",                g_packageVfsRootPath / L"Personal"sv,               false, FID_Documents,                                                  mfr::mfr_redirect_flags::prefer_redirection_local });
        ...
        g_MfrFolderMappings.push_back(mfr::mfr_folder_mapping{ true, FID_PublicDesktop,                    L"Common Desktop",                  L"Common Desktop",          g_packageVfsRootPath / L"Common Desktop"sv,         false, FID_PublicDesktop,                                              mfr::mfr_redirect_flags::prefer_redirection_local });
        g_MfrFolderMappings.push_back(mfr::mfr_folder_mapping{ true, FID_PublicDocuments,                  L"Common Documents",                L"Common Documents",        g_packageVfsRootPath / L"Common Documents"sv,       false, FID_PublicDocuments,                                            mfr::mfr_redirect_flags::prefer_redirection_local });
