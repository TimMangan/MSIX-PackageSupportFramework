...
std::wstring CanReplaceWithVFS(Json_Debug_Levels debugRequestLevel, const wchar_t* moduleName, DWORD dllInstance, const std::wstring input)
{
    ...
    try
    {
        ...
        {
            LogString(debugRequestLevel, moduleName, dllInstance, L"PackageRootPath is ", l_PackageRootPath.c_str());
            output = ((std::wstring)l_PackageRootPath.c_str()) + L"\\VFS\\Personal" + input.substr(testpath.wstring().length()).c_str();
            LogString(debugRequestLevel, moduleName, dllInstance, L"Replacement is ", output.c_str());
            return output;
        }
    }
    catch (...)
    {
        Log(LogLevel_Exception, L"[%s%d] Warning: unknown known folder FOLDERID_Documents", moduleName, dllInstance);
    }
    ...
    {
        Log(LogLevel_Exception, L"[%s%d] Warning: unknown known folder FOLDERID_PublicDocuments", moduleName, dllInstance);
    }
    ...
    {
        Log(LogLevel_Exception, L"[%s%d] Warning: unknown known folder FOLDERID_LocalAppData", moduleName, dllInstance);
    }
    ...
    {
        Log(LogLevel_Exception, L"[%s%d] Warning: unknown known folder FOLDERID_RoamingAppData", moduleName, dllInstance);
    }
    ...
    {
        Log(LogLevel_Exception, L"[%s%d] Warning: unknown known folder FOLDERID_ProgramFilesCommonX86", moduleName, dllInstance);
    }
    ...
    {
        Log(LogLevel_Exception, L"[%s%d] Warning: unknown known folder FOLDERID_ProgramFilesX86", moduleName, dllInstance);
    }
    ...
    {
        Log(LogLevel_Exception, L"[%s%d] Warning: unknown known folder FOLDERID_ProgramFilesCommonX64", moduleName, dllInstance);
    }
    ...
    {
        Log(LogLevel_Exception, L"[%s%d] Warning: unknown known folder FOLDERID_ProgramFilesX64", moduleName, dllInstance);
    }
    ...
    {
        Log(LogLevel_Exception, L"[%s%d] Warning: unknown known folder FOLDERID_System", moduleName, dllInstance);
    }
    try
    {
    ...
    {
        Log(LogLevel_Exception, L"[%s%d] Warning: unknown known folder FOLDERID_SystemX86", moduleName, dllInstance);
    }
    ...
    {
        Log(LogLevel_Exception, L"[%s%d] Warning: unknown known folder FOLDERID_Fonts", moduleName, dllInstance);
    }
    ...
    {
        Log(LogLevel_Exception, L"[%s%d] Warning: unknown known folder FOLDERID_Windows", moduleName, dllInstance);
    }
    ...
    {
        Log(LogLevel_Exception, L"[%s%d] Warning: unknown known folder FOLDERID_ProgramData", moduleName, dllInstance);
    }
    ...
    {
        Log(LogLevel_Exception, L"[%s%d] Warning: unknown known folder FOLDERID_PublicDesktop", moduleName, dllInstance);
    }
    ...
    {
        Log(LogLevel_Exception, L"[%s%d] Warning: unknown known folder FOLDERID_CommonProgram", moduleName, dllInstance);
    }
    ...
    {
        Log(LogLevel_Exception, L"[%s%d] Warning: unknown known folder FOLDERID_LocalAppDataLow", moduleName, dllInstance);
    }

    return output;
}

std::wstring ArgumentVirtualization(Json_Debug_Levels debugRequestLevel, const wchar_t* moduleName, DWORD dllInstance, const std::wstring input)
{
    std::wstring output = L"";
    ...
    if (findStringIC(input, L"C:\\"))
    {
        ...
        while (offset < input.length())
        {
            if (findStringIC(input.substr(offset,3), L"C:\\"))
            {
                ...
                if (len != std::wstring::npos)
                {
                    std::wstring replacement = CanReplaceWithVFS(debugRequestLevel, moduleName, dllInstance, input.substr(offset,len));
