...
int InitializeAttributeTests()
{
    ...
    //  but not sub-folder or files below so ANY app shortenting the filename will fail.  If this test fails, try the SHORTNAMEFIXED case and be happy!
    temp = L"C:\\Progra~1\\Shorte~1\\Subdir\\subdir\\FileA1.txt";
#if SHORTNAMEFIXED
    MfrAttributeTest t_Native_Short1 = { "MFR+ILV Native-shortnamefile VFS exists in package", true, true, true,
...
MfrAttributeFileTests.push_back(t_Native_Short1);
    ...
    MfrAttributeTest t_Native_PF2 = { "MFR+ILV Native-file VFS missing in package", true, false, false,
    ...
    MfrAttributeTest t_Native_PF3 = { "MFR+ILV Native-file VFS parent-folder missing in package", true, false, false,
                                    temp.c_str(), INVALID_FILE_ATTRIBUTES, ERROR_PATH_NOT_FOUND };
...
#endif
    MfrAttributeTest t_Vfs_PF2 = { "MFR+ILV Package-file VFS missing in package", true, false, false, 
...
#endif
    MfrAttributeTest t_Vfs_PF3 = { "MFR+ILV Package-file VFS parent-folder missing in package", true, false, false, 
...
#endif
    MfrAttributeTest t_Redir_PF2 = { "MFR+ILV Redirected-file VFS missing in package", true, false, false, 
                                    temp, INVALID_FILE_ATTRIBUTES, ERROR_FILE_NOT_FOUND };
...
#endif
    MfrAttributeTest t_Redir_PF3 = { "MFR+ILV Redirected-file VFS parent-folder missing in package", true, false, false, 
                                    temp, INVALID_FILE_ATTRIBUTES, ERROR_PATH_NOT_FOUND };
    ...
    MfrAttributeTest t_Package_PV2 = { "MFR+ILV Package-file PVAD missing in package", true, false, false, 
                                    temp, INVALID_FILE_ATTRIBUTES, ERROR_FILE_NOT_FOUND };
    MfrAttributeFileTests.push_back(t_Package_PV2);

    temp = g_Cwd + L"\\NonExistentFolder\\NonExistent2.txt";
    MfrAttributeTest t_Package_PV3 = { "MFR+ILV Package-file PVAD parent-folder missing in package", true, false, false, 
                                    temp, INVALID_FILE_ATTRIBUTES, ERROR_PATH_NOT_FOUND };
    ...
    temp = g_writablePackageRootPath.c_str();
    temp.append(L"\\NonExistent3.txt");
    MfrAttributeTest t_Redir_PV2 = { "MFR+ILV Redirected-file PVAD missing in package", true, false, false, 
                                    temp, INVALID_FILE_ATTRIBUTES, ERROR_FILE_NOT_FOUND };
    MfrAttributeFileTests.push_back(t_Redir_PV2);

    temp = g_writablePackageRootPath.c_str();
    temp.append(L"\\VFS\\NonExistentFolder\\NonExistent4.txt");
    MfrAttributeTest t_Redir_PV3 = { "MFR+ILV Redirected-file PVAD parent-folder missing in package", true, false, false, 
                                    temp, INVALID_FILE_ATTRIBUTES, ERROR_PATH_NOT_FOUND };
    ...
    MfrAttributeTest t_Native_PFo1 = { "MFR+ILV Native-folder VFS exists in package", true, true, true,
                                    temp.c_str(), 0x10, ERROR_SUCCESS };
    MfrAttributeFolderTests.push_back(t_Native_PFo1);

    temp = g_NativePF;
    temp.append(L"\\MissingPlaceholderTest");
    MfrAttributeTest t_Native_PFo2 = { "MFR+ILV Native-folder VFS missing in package", true, false, false,
                                    temp.c_str(), INVALID_FILE_ATTRIBUTES, ERROR_FILE_NOT_FOUND };
    MfrAttributeFolderTests.push_back(t_Native_PFo2);

    temp = g_NativePF;
    temp.append(L"\\MissingPlaceholderTest\\MissingPlaceholder2");
    MfrAttributeTest t_Native_PFo3 = { "MFR+ILV Native-folder VFS parent-folder missing in package", true, false, false,
                                    temp.c_str(), INVALID_FILE_ATTRIBUTES, ERROR_PATH_NOT_FOUND };
...
#endif
    MfrAttributeTest t_Vfs_PFo1 = { "MFR+ILV Package-folder VFS exists in package", true, true, true, 
...
#endif
    MfrAttributeTest t_Vfs_PFo2 = { "MFR+ILV Package-folder VFS missing in package", true, false, false, 
                                    temp, INVALID_FILE_ATTRIBUTES, ERROR_FILE_NOT_FOUND };
...
#endif
    MfrAttributeTest t_Vfs_PFo3 = { "MFR+ILV Package-folder VFS parent-folder missing in package", true, false, false,
                                    temp, INVALID_FILE_ATTRIBUTES, ERROR_PATH_NOT_FOUND };
...
#endif
    MfrAttributeTest t_Redir_PFo1 = { "MFR+ILV Redirected-folder VFS exists in package", true, true, true, 
                                    temp, 0x10, ERROR_SUCCESS };
...
#endif
    MfrAttributeTest t_Redir_PFo2 = { "MFR+ILV Redirected-folder VFS missing in package", true, false, false, 
                                    temp, INVALID_FILE_ATTRIBUTES, ERROR_FILE_NOT_FOUND };
...
#endif
    MfrAttributeTest t_Redir_PFo3 = { "MFR+ILV Redirected-folder VFS parent-folder missing in package", true, false, false, 
                                    temp, INVALID_FILE_ATTRIBUTES, ERROR_PATH_NOT_FOUND };
    ...
    temp = g_NativePF;
    temp.append(L"\\PlaceholderTest\\Placeholder.txt");
    MfrAttributeExTest t_Native_ExPF1 = { "MFR+ILV Ex Native-file VFS exists in package", true, true, true,
                                    temp.c_str(), true, ERROR_SUCCESS };
    MfrAttributeExFileTests.push_back(t_Native_ExPF1);

    temp = g_NativePF;
    temp.append(L"\\PlaceholderTest\\MissingPlaceholder.txt");
    MfrAttributeExTest t_Native_ExPF2 = { "MFR+ILV Ex Native-file VFS missing in package", true, false, false,
                                    temp.c_str(), false, ERROR_FILE_NOT_FOUND };
    MfrAttributeExFileTests.push_back(t_Native_ExPF2);

    temp = g_NativePF;
    temp.append(L"\\MissingPlaceholderTest\\MissingPlaceholder.txt");
    MfrAttributeExTest t_Native_ExPF3 = { "MFR+ILV Ex Native-file VFS parent-folder missing in package", true, false, false,
    ...
    temp = g_Cwd + L"\\VFS\\ProgramFilesX64\\PlaceholderTest\\Placeholder.txt";
#endif
    MfrAttributeExTest t_Vfs_ExPF1 = { "MFR+ILV Ex Package-file VFS exists in package", true, true, true, 
    ...
    temp = g_Cwd + L"\\VFS\\ProgramFilesX64\\PlaceholderTest\\MissingPlaceholder.txt";
#endif
    MfrAttributeExTest t_Vfs_ExPF2 = { "MFR+ILV Ex Package-file VFS missing in package", true, false, false, 
    ...
    temp = g_Cwd + L"\\VFS\\ProgramFilesX64\\MissingPlaceholderTest\\MissingPlaceholder.txt";
#endif
    MfrAttributeExTest t_Vfs_ExPF3 = { "MFR+ILV Ex Package-file VFS parent-folder missing in package", true, false, false, 
    ...
    temp.append(L"\\VFS\\ProgramFilesX64\\PlaceholderTest\\Placeholder.txt");
#endif
    MfrAttributeExTest t_Redir_ExPF1 = { "MFR+ILV Ex Redirected-file VFS exists in package", true, true, true, 
                                    temp, true, ERROR_SUCCESS };
    ...
    temp.append(L"\\VFS\\ProgramFilesX64\\PlaceholderTest\\MissingPlaceholder.txt");
#endif
    MfrAttributeExTest t_Redir_ExPF2 = { "MFR+ILV Ex Redirected-file VFS missing in package", true, false, false,
                                    temp, false, ERROR_FILE_NOT_FOUND };
    ...
    temp.append(L"\\VFS\\ProgramFilesX64\\MissingPlaceholderTest\\MissingPlaceholder.txt");
#endif
    MfrAttributeExTest t_Redir_ExPF3 = { "MFR+ILV Ex Redirected-file VFS parent-folder missing in package", true, false, false, 
                                    temp, false, ERROR_PATH_NOT_FOUND };
    MfrAttributeExFileTests.push_back(t_Redir_ExPF3);

    // Requests to Package File Locations for GetFileAttributes using PVAD
    temp = g_Cwd + L"\\PvadFile1.txt";
    MfrAttributeExTest t_Package_ExPV1 = { "MFR+ILV Package-file PVAD exists in package", true, true, true, 
                                        temp, true, ERROR_SUCCESS };
    MfrAttributeExFileTests.push_back(t_Package_ExPV1);

    temp = g_Cwd + L"\\NonExistent1.txt";
    MfrAttributeExTest t_Package_ExPV2 = { "MFR+ILV Package-file PVAD missing in package", true, false, false, 
                                        temp, false, ERROR_FILE_NOT_FOUND };
    MfrAttributeExFileTests.push_back(t_Package_ExPV2);

    temp = g_Cwd + L"\\NonExistentFolder\\NonExistent1.txt";
    MfrAttributeExTest t_Package_ExPV3 = { "MFR+ILV Package-file PVAD parent-folder missing in package", true, false, false, 
                                        temp, false, ERROR_PATH_NOT_FOUND };
    ...
    temp = g_writablePackageRootPath.c_str();
    temp.append(L"\\PvadFile1.txt");
    MfrAttributeExTest t_Redir_ExPV1 = { "MFR+ILV Redirected-file PVAD exists in package", true, true, true, 
                                    temp, true, ERROR_SUCCESS };
    MfrAttributeExFileTests.push_back(t_Redir_ExPV1);

    temp = g_writablePackageRootPath.c_str();
    temp.append(L"\\NonExistent1.txt");
    MfrAttributeExTest t_Redir_ExPV2 = { "MFR+ILV Redirected-file PVAD missing in package", true, false, false, 
                                    temp, false, ERROR_FILE_NOT_FOUND };
    MfrAttributeExFileTests.push_back(t_Redir_ExPV2);

    temp = g_writablePackageRootPath.c_str();
    temp.append(L"\\VFS\\NonExistentFolder\\NonExistent1.txt");
    MfrAttributeExTest t_Redir_ExPV3 = { "MFR+ILV Redirected-file PVAD parent-folder missing in package", true, false, false, 
                                    temp, false, ERROR_PATH_NOT_FOUND };
    ...
    temp = g_NativePF;
    temp.append(L"\\PlaceholderTest\\Placeholder.txt");
    MfrSetAttributeTest t_Native_SetPF1 = { "MFR+ILV Set Native-file VFS exists in package", true, true, true,
                                    temp.c_str(), FILE_ATTRIBUTE_NORMAL, true, 0x20, ERROR_SUCCESS };
    MfrSetAttributeFileTests.push_back(t_Native_SetPF1);

    temp = g_NativePF;
    temp.append(L"\\PlaceholderTest\\MissingPlaceholder.txt");
    MfrSetAttributeTest t_Native_SetPF2 = { "MFR+ILV Set Native-file VFS missing in package", true, false, false,
    ...
    temp = g_NativePF;
    temp.append(L"\\MissingPlaceholderTest\\MissingPlaceholder.txt");
    MfrSetAttributeTest t_Native_SetPF3 = { "MFR+ILV Set Native-file VFS parent-folder missing in package", true, false, false,
    ...
    temp = g_Cwd + L"\\VFS\\ProgramFilesX64\\PlaceholderTest\\Placeholder.txt";
#endif
    MfrSetAttributeTest t_Vfs_SetPF1 = { "MFR+ILV Set Package-file VFS exists in package", true, true, true, 
    ...
    temp = g_Cwd + L"\\VFS\\ProgramFilesX64\\PlaceholderTest\\MissingPlaceholder.txt";
#endif
    MfrSetAttributeTest t_Vfs_SetPF2 = { "MFR+ILV Set Package-file VFS missing in package", true, false, false, 
    ...
    temp = g_Cwd + L"\\VFS\\ProgramFilesX64\\MissingPlaceholderTest\\MissingPlaceholder.txt";
#endif
    MfrSetAttributeTest t_Vfs_SetPF3 = { "MFR+ILV Set Package-file VFS parent-folder missing in package", true, false, false, 
    ...
    MfrSetAttributeTest t_Native_SetPF1H = { "MFR+ILV Set Hidden Native-file VFS exists in package", true, false, false, 
    ...
    MfrSetAttributeTest t_Native_SetPF1D = { "MFR+ILV Set Directory Native-folder VFS not in package", true, false, false, 
...
#endif
    MfrSetAttributeTest t_Vfs_SetPF1D = { "MFR+ILV Set Directory Package-folder VFS not in package", true, false, false, 
...
#endif
    MfrSetAttributeTest t_Redir_PF1D = { "MFR+ILV Set Directory Redirected-folder VFS not in package", true, false, false, 
                                    temp, FILE_ATTRIBUTE_DIRECTORY, false, INVALID_FILE_ATTRIBUTES, ERROR_FILE_NOT_FOUND };
    MfrSetAttributeFolderTests.push_back(t_Redir_PF1D);

    temp = g_Cwd + L"\\PsfLauncher.exe"; 
    MfrSetAttributeTest t_Exe_PVAD1 = { "MFR+ILV Set Package-file PVAD Exe to Hidden", true, false, false, 
                                    temp, FILE_ATTRIBUTE_ARCHIVE|FILE_ATTRIBUTE_HIDDEN, true, FILE_ATTRIBUTE_ARCHIVE | FILE_ATTRIBUTE_HIDDEN, ERROR_SUCCESS };
    MfrSetAttributeFileTests.push_back(t_Exe_PVAD1);

    temp = g_Cwd + L"\\PvadFolder\\PvadFile2.txt";
    MfrSetAttributeTest t_Exe_PVAD2 = { "MFR+ILV Set Package-file PVAD txt to Hidden", true, false, false,
                                temp, FILE_ATTRIBUTE_ARCHIVE|FILE_ATTRIBUTE_HIDDEN, true, FILE_ATTRIBUTE_ARCHIVE | FILE_ATTRIBUTE_HIDDEN, ERROR_SUCCESS };
    MfrSetAttributeFileTests.push_back(t_Exe_PVAD2);
...
int RunAttributeTests()
{
    ...
    for (MfrAttributeTest testInput : MfrAttributeFileTests)
    {
        ...
        {
            std::string testname = "MFR+ILV GetFileAttributes File Test: ";
    ...
    for (MfrAttributeTest testInput : MfrAttributeFolderTests)
    {
        if (testInput.enabled)
        {
            std::string testname = "MFR+ILV GetFileAttributes Folder Test: ";
            testname.append(testInput.TestName);
            test_begin(testname);
    ...
    if (fileInformation != NULL)
    {
        for (MfrAttributeExTest testInput : MfrAttributeExFileTests)
        {
            if (testInput.enabled)
            {
                std::string testname = "MFR+ILV GetFileAttributesEx File Test: ";
                testname.append(testInput.TestName);
                test_begin(testname);
    ...
    for (MfrSetAttributeTest testInput : MfrSetAttributeFileTests)
    {
        if (testInput.enabled)
        {
            std::string testname = "MFR+ILV SetFileAttributes File Test: ";
            testname.append(testInput.TestName);
    ...
    for (MfrSetAttributeTest testInput : MfrSetAttributeFolderTests)
    {
        if (testInput.enabled)
        {
            std::string testname = "MFR+ILV SetFileAttributes Folder Test: ";
            testname.append(testInput.TestName);
            test_begin(testname);
